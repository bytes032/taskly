...
export class TaskLinkWidget extends WidgetType {
	...
	toDOM(view: EditorView): HTMLElement {
		...
		// Create a wrapper span with the taskly-plugin class for CSS scoping
		const wrapper = document.createElement("span");
		wrapper.className = "taskly-plugin taskly-inline-widget";
		...
		card.addEventListener("taskly:task-updated", () => {
			setTimeout(() => {
