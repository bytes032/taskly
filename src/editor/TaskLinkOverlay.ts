...
export function createTaskLinkViewPlugin(plugin: TasklyPlugin) {
...
function getTaskInfoSync(filePath: string, plugin: TasklyPlugin): TaskInfo | null {
	// Validate inputs
...
export function createTaskLinkOverlay(plugin: TasklyPlugin): Extension {
