...
export class FilterUtils {
	 ...
	 * Supports Obsidian nested tags where 'work' matches 'work/alpha', 'work/beta', etc.
	 ...
	 *
	 * @param taskTag - The tag from the task (e.g., 'work/alpha')
	 * @param conditionTag - The condition tag without hyphen prefix (e.g., 'work')
	...
	static matchesHierarchicalTag(taskTag: string, conditionTag: string): boolean {
		...
		// 'work/alpha' should match when searching for 'work'
		...
		// This allows partial matches like 'urg' to match 'urgent/now'
