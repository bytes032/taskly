...
// Default copy destination is empty; set OBSIDIAN_PLUGIN_PATH or .copy-files.local
const defaultPaths = [];
...
async function copyFiles() {
    try {
        if (copyPaths.length === 0) {
            console.error('❌ No copy destination configured. Set OBSIDIAN_PLUGIN_PATH or add paths to .copy-files.local.');
            process.exit(1);
        }
